                    ...
                    {project.images.map((image) => (
                        ...
                        >
                            <a
                                href={image}
                                target="_blank"
                                className="absolute top-4 right-4 bg-background/70 text-foreground size-12 inline-flex justify-center items-center transition-all opacity-0 hover:bg-[#5EABD6] hover:text-primary-foreground group-hover:opacity-100"
                            >
                                <ExternalLink />
                            </a>
                        </div>
